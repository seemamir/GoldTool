...
class Layout1 extends React.Component {
  ...
  getValue = e => {
    ...
    const multi = euro * this.state.timeInYears;
    const output = multi + e.target.value;
    this.setState({
      output,
    });
  };
        ...
        <Form onSubmit={handleSubmit} hideRequiredMark={false}>
          ...
          <Row className="m-v-30">
            ...
            <Col span={14}>
              ...
              <Button className="m-l-10" type="primary" value="25">
                25
              </Button>
              <Button className="m-l-10" type="primary" value="50">
                50
              </Button>
              <Button className="m-l-10" type="primary" value="75">
                75
              </Button>
            </Col>
          </Row>
